...
"[project]/node_modules/dom-to-image-more/dist/dom-to-image-more.min.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

/*! dom-to-image-more 23-10-2025 */ ((l)=>{
    let m = (()=>{
        let e = 0;
        return {
            escape: function(e) {
            ...
            canvasToBlob: function(t) {
                ...
                return ((r)=>new Promise(function(e) {
                        var t = s(r.toDataURL().split(",")[1]), n = t.length, o = new Uint8Array(n);
            ...
            resolveUrl: function(e, t) {
                var n = document.implementation.createHTMLDocument(), o = n.createElement("base"), r = (n.head.appendChild(o), n.createElement("a"));
            ...
            getAndEncode: function(l) {
                ...
                null === e.promise && (d.impl.options.cacheBust && (l += (/\?/.test(l) ? "&" : "?") + (new Date).getTime()), e.promise = new Promise(function(n) {
                    ...
                    if (r.timeout = d.impl.options.httpTimeout, r.onerror = t, r.ontimeout = t, r.onloadend = function() {
                        ...
                        let t = !1, n = d.impl.options.corsImg.headers || {}, o = (Object.keys(n).forEach(function(e) {
            ...
            makeImage: function(r) {
                return "data:," !== r ? new Promise(function(e, t) {
                    let n = document.createElementNS("http://www.w3.org/2000/svg", "svg"), o = new Image;
            ...
            width: function(e) {
                var t = i(e, "width");
                if (!isNaN(t)) return t;
                var t = i(e, "border-left-width"), n = i(e, "border-right-width");
                return e.scrollWidth + t + n;
            },
            height: function(e) {
                var t = i(e, "height");
                if (!isNaN(t)) return t;
                var t = i(e, "border-top-width"), n = i(e, "border-bottom-width");
        ...
        function n(e) {
            ...
            return n.filter(function(e) {
                return !m.isDataUrl(e);
            });
        }
        function r(e) {
            return new RegExp(`url\\((["']?)(${m.escape(e)})\\1\\)`, "gm");
        }
        function i(n, o, t, e) {
            return Promise.resolve(o).then(function(e) {
                return t ? m.resolveUrl(e, t) : e;
            }).then(e || m.getAndEncode).then(function(e) {
                var t = r(o);
                return n.replace(t, `url($1${e}$1)`);
            });
        }
    })(), e = {
        resolveAll: function() {
    ...
    function t() {
        return Promise.resolve(m.asArray(document.styleSheets)).then(function(e) {
            let n = [];
            return e.forEach(function(t) {
                var e = Object.getPrototypeOf(t);
                if (Object.prototype.hasOwnProperty.call(e, "cssRules")) try {
                    m.asArray(t.cssRules || []).forEach(n.push.bind(n));
                } catch (e) {
    ...
    let n = {
        inlineAll: function t(e) {
            if (!m.isElement(e)) return Promise.resolve(e);
            return n(e).then(function() {
                return m.isHTMLImageElement(e) ? o(e).inline() : Promise.all(m.asArray(e.childNodes).map(function(e) {
                    return t(e);
                }));
            });
            //TURBOPACK unreachable
            ...
            function n(o) {
                let e = [
                    ...
                    let e = o.style.getPropertyValue(t), n = o.style.getPropertyPriority(t);
    ...
    function o(n) {
        return {
            inline: function(e) {
                if (m.isDataUrl(n.src)) return Promise.resolve();
                return Promise.resolve(n.src).then(e || m.getAndEncode).then(function(t) {
    ...
    let i = {
        ...
        toBlob: function(e, t) {
            return a(e, t).then(m.canvasToBlob);
        },
        toPixelData: function(t, e) {
            return a(t, e).then(function(e) {
                return e.getContext("2d").getImageData(0, 0, m.width(t), m.height(t)).data;
            });
        },
        toCanvas: a,
        impl: {
    ...
    }, f = (("TURBOPACK compile-time truthy", 1) ? module.exports = d : "TURBOPACK unreachable", (void 0 === Node ? void 0 : Node.ELEMENT_NODE) || 1), h = (void 0 === l ? void 0 : l.getComputedStyle) || (void 0 === window ? void 0 : window.getComputedStyle) || globalThis.getComputedStyle, s = (void 0 === l ? void 0 : l.atob) || (void 0 === window ? void 0 : window.atob) || globalThis.atob;
    function u(t, r) {
        let n = d.impl.util.getWindow(t), o = (r = r || {}, d.impl.copyOptions(r), []);
        return Promise.resolve(t).then(function(e) {
            if (e.nodeType === f) return e;
            var t = e, n = document.createElement("span");
            return t.replaceWith(n), n.append(e), o.push({
                child: t,
                wrapper: n
            }), n;
        }).then(function(e) {
            return function l(t, s, i, u) {
                let e = s.filter;
                if (t === p || m.isHTMLScriptElement(t) || m.isHTMLStyleElement(t) || m.isHTMLLinkElement(t) || null !== i && e && !e(t)) return Promise.resolve();
                ...
                ;
                function n(e) {
                    return m.isHTMLCanvasElement(e) ? m.makeImage(e.toDataURL()) : e.cloneNode(!1);
                }
                function o(e) {
                ...
                function a(e) {
                    return m.isElementHostForOpenShadowRoot(e) ? e.shadowRoot : e;
                }
                function c(n, e) {
                    let o = t(e), r = Promise.resolve();
                    if (0 !== o.length) {
                        let t = h(i(e));
                        m.asArray(o).forEach(function(e) {
                            r = r.then(function() {
                    ...
                    ;
                    function i(e) {
                        return m.isShadowRoot(e) ? e.host : e;
                    }
                    function t(t) {
                        if (m.isShadowSlotElement(t)) {
                ...
                function d(u, a) {
                    return !m.isElement(u) || m.isShadowSlotElement(a) ? Promise.resolve(u) : Promise.resolve().then(t).then(n).then(o).then(r).then(e).then(function() {
                        return u;
                    });
                    //TURBOPACK unreachable
                    ;
                    function e() {
                        m.isHTMLImageElement(u) && (u.removeAttribute("loading"), a.srcset || a.sizes) && (u.removeAttribute("srcset"), u.removeAttribute("sizes"), u.src = a.currentSrc || a.src);
                    }
                    function t() {
                        function o(e, t) {
                        ...
                        function e(e, t) {
                            let n = h(e);
                            n.cssText ? (t.style.cssText = n.cssText, o(n, t.style)) : (y(s, e, n, i, t), null === i && ([
                                "inset-block",
                                "inset-block-start",
                                "inset-block-end"
                    ...
                    function n() {
                        let s = m.uid();
                        function t(r) {
                            let i = h(a, r), l = i.getPropertyValue("content");
                            if ("" !== l && "none" !== l) {
                                let e = u.getAttribute("class") || "", t = (u.setAttribute("class", e + " " + s), document.createElement("style"));
                                function n() {
                                    let e = `.${s}:` + r, t = (i.cssText ? n : o)();
                                    ...
                                    function o() {
                                        let e = m.asArray(i).map(t).join("; ");
                                        return e + ";";
                                        //TURBOPACK unreachable
                                        ;
                                        function t(e) {
                                            let t = i.getPropertyValue(e), n = i.getPropertyPriority(e) ? " !important" : "";
                                            return e + ": " + t + n;
                                        }
                                    }
                                }
                    ...
                    function o() {
                        m.isHTMLTextAreaElement(a) && (u.innerHTML = a.value), m.isHTMLInputElement(a) && u.setAttribute("value", a.value);
                    }
                    function r() {
                        m.isSVGElement(u) && (u.setAttribute("xmlns", "http://www.w3.org/2000/svg"), m.isSVGRectElement(u)) && [
                            "width",
                            "height"
                        ].forEach(function(e) {
            ...
            let n = r.width || m.width(t), o = r.height || m.height(t);
            return Promise.resolve(e).then(function(e) {
                return e.setAttribute("xmlns", "http://www.w3.org/1999/xhtml"), (new XMLSerializer).serializeToString(e);
            }).then(m.escapeXhtml).then(function(e) {
                var t = (m.isDimensionMissing(n) ? ' width="100%"' : ` width="${n}"`) + (m.isDimensionMissing(o) ? ' height="100%"' : ` height="${o}"`);
                return `<svg xmlns="http://www.w3.org/2000/svg"${(m.isDimensionMissing(n) ? "" : ` width="${n}"`) + (m.isDimensionMissing(o) ? "" : ` height="${o}"`)}><foreignObject${t}>${e}</foreignObject></svg>`;
            }).then(function(e) {
    ...
    function a(r, i) {
        return u(r, i = i || {}).then(m.makeImage).then(function(e) {
            var t = "number" != typeof i.scale ? 1 : i.scale, n = ((e, t)=>{
                let n = i.width || m.width(e), o = i.height || m.height(e);
                return m.isDimensionMissing(n) && (n = m.isDimensionMissing(o) ? 300 : 2 * o), m.isDimensionMissing(o) && (o = n / 2), (e = document.createElement("canvas")).width = n * t, e.height = o * t, i.bgcolor && ((t = e.getContext("2d")).fillStyle = i.bgcolor, t.fillRect(0, 0, e.width, e.height)), e;
            })(r, t), o = n.getContext("2d");
    ...
    function y(i, l, s, u, e) {
        let a = d.impl.options.copyDefaultStyles ? ((t, e)=>{
            var n, o = ((e)=>("relaxed" !== t.styleCaching ? e : e.filter((e, t, n)=>0 === t || t === n.length - 1)).join(">"))(e = ((e)=>{
                var t = [];
                do {
                    if (e.nodeType === f) {
                        var n = e.tagName;
            ...
            })(e));
            {
                ...
                e = ((e, t)=>{
                    ...
                    t = document.characterSet || "UTF-8", e = (e = document.doctype) ? (`<!DOCTYPE ${s(e.name)} ${s(e.publicId)} ` + s(e.systemId)).trim() + ">" : "", (p = document.createElement("iframe")).id = "domtoimage-sandbox-" + m.uid(), p.style.top = "-9999px", p.style.visibility = "hidden", p.style.position = "fixed", document.body.appendChild(p);
                    var e, t, n = p, o = "domtoimage-sandbox";
                    try {
                    ...
                    try {
                        var i = document.implementation.createHTMLDocument(o), l = (i.head.appendChild(r), e + i.documentElement.outerHTML);
                    ...
                    let n = {}, o = e.getComputedStyle(t);
                    return m.asArray(o).forEach(function(e) {
        ...
        m.asArray(s).forEach(function(e) {
            var t, n, o, r;
            i.filterStyles && !i.filterStyles(l, e) || (n = s.getPropertyValue(e), o = a[e], t = u ? u.getPropertyValue(e) : void 0, c.getPropertyValue(e)) || (n !== o || u && n !== t) && (o = s.getPropertyPriority(e), t = c, n = n, o = o, r = 0 <= [
                "background-clip"
            ].indexOf(e = e), o ? (t.setProperty(e, n, o), r && t.setProperty("-webkit-" + e, n, o)) : (t.setProperty(e, n), r && t.setProperty("-webkit-" + e, n)));
        });
    }
    let v = null, w = {}, E = [
        "ADDRESS",
...
})(/*TURBOPACK member replacement*/ __turbopack_context__.e); //# sourceMappingURL=dom-to-image-more.min.js.map
}),
]);

//# sourceMappingURL=node_modules_dom-to-image-more_dist_dom-to-image-more_min_7cdffe53.js.map